...
# Migration Fix Script for cli
# This script fixes migration issues for the cli app
...
# Display warning
echo ""
log_warn "⚠️  WARNING: This will modify your database and migration files for cli!"
echo ""
...
log_info "📦 Processing cli migrations..."
echo "──────────────────────────────────────────────────"
