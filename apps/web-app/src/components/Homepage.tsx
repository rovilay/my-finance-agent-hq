...
function CapabilityCard({
  ...
  return (
    <div className="card-hover p-6 rounded-xl border border-neutral-200 bg-white space-y-4">
      <div>{icon}</div>
...
function Step({
  ...
  return (
    <div className="text-center space-y-4">
      <div className="w-12 h-12 rounded-full bg-primary-600 text-white font-bold text-xl flex items-center justify-center mx-auto">
        {number}
      </div>
      ...
      <Container>
        <section className="py-12 md:py-20 px-4">
          <div className="max-w-4xl mx-auto text-center space-y-6">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary-100 text-primary-700 text-xs md:text-sm font-medium animate-fade-in">
              <span>🇨🇦</span>
              Canadian taxes, made simple
            </div>

            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-display font-bold text-neutral-900 text-balance animate-slide-up">
              Understand your taxes.
              <span className="text-primary-600"> File with confidence.</span>
            </h1>

            <p
              className="text-base md:text-lg lg:text-xl text-neutral-600 mb-4 max-w-2xl mx-auto animate-slide-up"
            ...
            <p
              className="text-xs md:text-sm text-neutral-500 mb-6 md:mb-8 max-w-xl mx-auto animate-slide-up"
        ...
        <section className="py-12 md:py-20 px-4 bg-white">
          <div className="text-center mb-8 md:mb-14">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-display font-bold text-neutral-900 mb-3 md:mb-4">
              Everything you need in one place
            </h2>
            <p className="text-base md:text-lg text-neutral-600 max-w-2xl mx-auto px-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
            <Link href={GUIDE_ROUTE} className="group block">
              <div className="card-hover p-6 rounded-xl border border-neutral-200 bg-white h-full group-hover:border-primary-300 transition-colors">
                ...
                <h3 className="text-base md:text-lg font-semibold text-neutral-900 mb-2 group-hover:text-primary-700">
                  Learn the basics
                </h3>
        ...
        <section className="py-12 md:py-20 px-4 bg-neutral-50">
          ...
          <p className="text-center text-xs md:text-sm text-neutral-500 mt-6 md:mt-8 px-4">
        ...
        {/* How it works */}
        <section className="py-12 md:py-20 px-4 bg-white" id="how-it-works">
        ...
        <section className="py-12 md:py-20 px-4 bg-neutral-50">
          <div className="max-w-4xl mx-auto">
            <div className="rounded-2xl bg-linear-to-br from-primary-600 to-primary-700 p-6 md:p-10 text-center text-white">
              <div className="w-12 md:w-14 h-12 md:h-14 rounded-full bg-white/20 flex items-center justify-center mx-auto mb-4 md:mb-5">
              ...
              <p className="text-sm md:text-lg text-primary-100 mb-4 md:mb-6 max-w-xl mx-auto">
              ...
              <div className="flex flex-wrap justify-center gap-2 mb-6 md:mb-8">
                {[
                  ...
                  <span
                    key={q}
                    className="px-2 md:px-3 py-1 md:py-1.5 bg-white/15 rounded-full text-xs md:text-sm text-white/90 border border-white/20"
                  >
                    {q}
                  </span>
                ))}
        ...
        <section className="py-12 md:py-16 px-4 bg-white border-t border-neutral-100">
          <div className="max-w-4xl mx-auto">
            <p className="text-center text-xs md:text-sm font-semibold text-neutral-500 uppercase tracking-wider mb-6 md:mb-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 md:gap-6 text-center">
              ...
              <div className="flex flex-col items-center gap-2">
                ...
                <p className="text-xs text-neutral-500">
                  AI extractions are always confirmed by you
                </p>
              </div>
              <div className="flex flex-col items-center gap-2">
        ...
        <section className="py-12 md:py-20 px-4 bg-neutral-50">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-base md:text-lg text-neutral-600 mb-6 md:mb-8 px-2">
            ...
            <p className="text-xs md:text-sm text-neutral-500 mt-3 md:mt-4">
        ...
        {/* Footer */}
        <footer className="border-t border-neutral-200 bg-white py-8 md:py-12 px-4">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <LogoWithText />
            <p className="text-xs md:text-sm text-neutral-500">
              © 2026 Finance Agent. All rights reserved.
            </p>
          </div>
        </footer>
      </Container>
