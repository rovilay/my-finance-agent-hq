            ...
            <div className="card p-8 animate-scale-in">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-3">
                  <label className="flex items-center gap-3 cursor-pointer group">
                    <input
                      ...
                      className="mt-1 w-4 h-4 rounded border-neutral-300 text-primary-600 focus:ring-primary-500 focus:ring-offset-0 cursor-pointer"
                    />
                ...
                <Button
                  ...
                  variant="primary"
                  size="lg"
                  className="w-full disabled:cursor-auto"
              ...
              <p className="mt-6 text-xs text-neutral-500 pl-7">
                Please review and accept our policies to create an account
              </p>
            </div>
