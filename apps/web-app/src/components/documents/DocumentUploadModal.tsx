                      ...
                      <div className="grid grid-cols-2 gap-4">
                        ...
                        >
                          ...
                          <p className="text-sm text-neutral-600">
                            Delete file after data extraction
                          </p>
                        </button>
                        ...
                        >
                          ...
                          <p className="text-sm text-neutral-600">Store encrypted file</p>
                        </button>
                      </div>
                    </div>
                      ...
                      <div className="flex gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-primary-700">
                            Your document will be encrypted with a unique key before upload.
                          </p>
                        </div>
                      </div>
                    </div>
