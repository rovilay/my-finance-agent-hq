...
import { Card, CardContent, Button, PageLoader, Tabs, Tab, Container } from '@/components/ui';
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-2">
          <div>
            ...
            <p className="text-neutral-600">
              Select a tax profile to upload documents, review entries, and track your tax estimate.
            </p>
          </div>
          <Button
            variant="primary"
                ...
                <Link key={entity.id} href={`/entities/${entity.id}`}>
                  <Card className="hover:shadow-lg transition-all duration-200 cursor-pointer h-full">
                    <CardContent className="p-6">
                      ...
                      <h3 className="font-semibold text-lg text-neutral-900 mb-2">{entity.name}</h3>
