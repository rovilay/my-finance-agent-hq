...
export type VerifyAndFinalizeDocumentMutation = { __typename?: 'Mutation', verifyAndFinalize: { __typename?: 'Document', id: string, status: DocumentStatus } };
...
export type GetDocumentsByEntityQuery = { __typename?: 'Query', documentsByEntity: { __typename?: 'PaginatedDocument', total: number, skip: number, take: number, hasMore: boolean, items: Array<{ __typename?: 'Document', id: string, entityId: string, fileName: string, status: DocumentStatus, retentionPolicy: RetentionPolicy, storagePath?: string | null, purgedAt?: any | null, decryptedData?: string | null, createdAt: any, updatedAt: any, fileMetadata: { __typename?: 'FileMetadata', mimeType: string, sizeInKb: number } }> } };
...
export type GetDocumentQuery = { __typename?: 'Query', document: { __typename?: 'Document', id: string, entityId: string, fileName: string, status: DocumentStatus, retentionPolicy: RetentionPolicy, storagePath?: string | null, purgedAt?: any | null, createdAt: any, updatedAt: any, decryptedData?: string | null, fileMetadata: { __typename?: 'FileMetadata', mimeType: string, sizeInKb: number } } };
...
export type GetTaxProjectionQuery = { __typename?: 'Query', getTaxProjection: { __typename?: 'TaxProjection', entityId: string, taxYear: string, totalIncome: number, taxableIncome: number, federalTax: number, provincialTax: number, totalTax: number, creditsApplied: number, totalTaxLiability: number, effectiveTaxRate: number, incomeTotal: number, deductionsTotal: number, creditsTotal: number, taxPaidTotal: number } };
